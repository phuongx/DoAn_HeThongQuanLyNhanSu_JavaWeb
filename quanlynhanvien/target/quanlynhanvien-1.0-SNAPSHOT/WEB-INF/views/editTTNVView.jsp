        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${pageContext.request.contextPath}/editTTNV">Chỉnh sửa thông tin</a></li>
                    <li><c:if test="${loginedUser.tenVT=='Admin'}">
                        <input type="button" value="Đổi mật khẩu" id="buttonClickMe" class="btn btn-primary">
                        </c:if></li>
                </ul>
                <br>
