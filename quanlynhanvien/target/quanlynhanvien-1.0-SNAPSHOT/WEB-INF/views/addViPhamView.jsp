<%-- 
    Document   : addViPhamView
    Created on : Aug 25, 2021, 8:48:25 PM
    Author     : Ms Phuong
--%>
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" action="${pageContext.request.contextPath}/nv/vipham/add" method="POST" name="frmTT">
