...
<nav class="navbar navbar-inverse navbar-fixed-top" >
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        ...
        <li><a href="${pageContext.request.contextPath}/viec">Lịch công việc <span class="badge">${soluong}</span></a></li>
        <li><a href="${pageContext.request.contextPath}/unknown" target="_blank">Đơn</a></li>
        <li><a href="${pageContext.request.contextPath}/nv/thongtin?maNV=${loginedUser.maNV}">Hồ sơ cá nhân</a></li>
