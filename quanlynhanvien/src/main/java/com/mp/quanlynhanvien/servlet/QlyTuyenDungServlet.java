...
public class QlyTuyenDungServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            list = DBUtils.getTinTuyenDung(conn);
        ...
        request.setAttribute("errorString", errorString);
        //chuyen huong
        RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/WEB-INF/views/qlyTinTuyenDungView.jsp");
        dispatcher.forward(request, response);
    }
