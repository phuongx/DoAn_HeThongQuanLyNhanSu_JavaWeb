...
public class TimHDTheoMaNVServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            list = DBUtils.getHopDongLaoDong(conn, maNV);
        ...
        request.getRequestDispatcher("/WEB-INF/views/timHD-MaNVView.jsp").forward(request, response);
