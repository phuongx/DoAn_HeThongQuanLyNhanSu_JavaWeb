...
public class SuaTinTuyenDungServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/editTinTuyenDungView.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        tin.setTenVT(tenVT);
        tin.setMota(mota);
        tin.setNgayBD(ngayBD);
        tin.setNgayKT(ngayKT);
        tin.setSoluong(soLuong);
        try {
            DBUtils.editTinTuyenDung(conn, tin);
        } catch (SQLException e){
            e.printStackTrace();
